...
using UCharts;
public class CBCnoCoriginal : MonoBehaviour
{
   ...
   public Slider sliderKtoU;
    ...
    {
        PlusPoints(dayXmorningCurrentEthicsSchool);
        PlusPoints(dayXafternoonCurrentEthicsSchool);
        PlusPoints(dayXeveningCurrentEthicsSchool);

        MinusPoints(dayYmorningCurrentEthicsSchool);
        MinusPoints(dayYafternoonCurrentEthicsSchool);
        MinusPoints(dayYeveningCurrentEthicsSchool);
        MinusPoints(dayZmorningCurrentEthicsSchool);
        MinusPoints(dayZafternoonCurrentEthicsSchool);
        MinusPoints(dayZeveningCurrentEthicsSchool);
    ...
    {
        MinusPoints(dayXmorningCurrentEthicsSchool);
        MinusPoints(dayXafternoonCurrentEthicsSchool);
        MinusPoints(dayXeveningCurrentEthicsSchool);

        PlusPoints(dayYmorningCurrentEthicsSchool);
        PlusPoints(dayYafternoonCurrentEthicsSchool);
        PlusPoints(dayYeveningCurrentEthicsSchool);
    ...
    public void ChooseDayZ()
    {
        ...
        PlusPoints(dayZmorningCurrentEthicsSchool);
        PlusPoints(dayZafternoonCurrentEthicsSchool);
        PlusPoints(dayZeveningCurrentEthicsSchool);
    ...
    public void PlusPoints(int schoolToPlusPointsTo)
    {
    ...
    public void MinusPoints(int schoolToMinusPointsFrom)
    {
